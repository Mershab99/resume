...
\resumeItemListStart
  ...
  \resumeItem{APIs/Tools}{: Kafka, RabbitMQ, DAPR, WebRTC, Helm, YAML, JSON}
  ...
  \resumeItem{Dev Ops}{: Kubernetes, AWS, GKS, K3s, Gitlab, Ansible, Docker, Jenkins, Gitlab Pipelines (CI/CD), Crossplane, Terraform}
