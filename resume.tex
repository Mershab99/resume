...
\section{Experience}
  \resumeSubHeadingListStart
	...
	{Full-Stack Software Engineer}{July 2020 - Present}
		\resumeItemListStart
			\resumeItem{}
			{Connecting users to homes powered by Python based ML reccomendations engine
			\resumeItem{}
			...
			\resumeItem{}
			{Implemented in memory caching lalyer for MongoDB which resulted in reduced time-series query latencies.}
			\resumeItem{}
